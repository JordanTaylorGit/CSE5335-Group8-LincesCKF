...
const products = [
  {
    ...
    colors: [
      { name: 'Cream', nameEs: 'Crema', value: '#f3eedf' },
      { name: 'Pink', nameEs: 'Rosa',  value: '#f6b7c1' },
      { name: 'Blue', nameEs: 'Azul',  value: '#1826b8' },
    ],
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
  ...
  },
  {
    ...
    colors: [
      { name: 'Black', nameEs: 'Negro',  value: '#000000' },
      { name: 'Maroon', nameEs: 'Granate', value: '#9d002d' },
      { name: 'Gold', nameEs: 'Dorado',   value: '#efe7b2' },
    ],
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
  ...
  },
  {
    ...
    colors: [
      ...
      { name: 'Pink', nameEs: 'Rosa',  value: '#f6b7c1' },
      { name: 'Blue', nameEs: 'Azul',  value: '#1826b8' },
      { name: 'Red', nameEs: 'Rojo',   value: '#9d002d' },
    ],
    sizes: ['One Size'],
  ...
  },
  {
    ...
    colors: [
      { name: 'Gold', nameEs: 'Dorado',  value: '#d7c27b' },
      { name: 'White', nameEs: 'Blanco', value: '#ffffff' },
      { name: 'Black', nameEs: 'Negro', value: '#111827' },
    ],
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
