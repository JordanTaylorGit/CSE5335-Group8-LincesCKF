  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-10 flex items-center justify-between h-18 py-4">
        {/* Logo */}
        <Link to="/" className="font-accent text-xl tracking-[0.2em] text-navy hover:text-silk-red transition-colors">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="font-body text-xs tracking-widest uppercase text-navy/60 hover:text-silk-red transition-colors"
          ...
          {/* Cart */}
          <Link to="/cart" className="relative text-navy hover:text-silk-red transition-colors" aria-label={t('nav.cart')}>
