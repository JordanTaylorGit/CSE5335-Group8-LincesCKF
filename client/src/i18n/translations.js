...
const translations = {
  en: {
    ...
    checkout: {
      ...
      inventory_unconfirmed: "Order placed, but inventory update was not confirmed. Please restart the backend server and test again.",
  ...
  es: {
    ...
    checkout: {
      ...
      inventory_unconfirmed: "Pedido realizado, pero no se confirmó la actualización de inventario. Reinicia el servidor backend y prueba de nuevo.",
